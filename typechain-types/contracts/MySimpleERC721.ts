...
export interface MySimpleERC721Interface extends utils.Interface {
  functions: {
    ...
    "withdrawAllFunds()": FunctionFragment;
  };
...
export interface MySimpleERC721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MySimpleERC721Interface;
  ...
  callStatic: {
    ...
    withdrawAllFunds(overrides?: CallOverrides): Promise<void>;
  };
